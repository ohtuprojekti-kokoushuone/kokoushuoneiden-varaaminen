...
router.get('/:calendarUserId/', async function (req, res) {
  try {
...
// <GetRouteSnippet>
// GET /calendar
router.get('/:calendarUserId/reservations', async function (req, res) {
  try {
    if (!(await isRequestAuthorized(req))) {
      res.status(401);
      const errorResponse = {
...
router.post('/:calendarUserId/reservations', async function (req, res) {
...
router.delete('/:calendarUserId/reservations/:reservationId', async function (req, res) {
...
router.patch('/:calendarUserId/reservations/:reservationId', async function (req, res) {
  try {
    ...
    const responseObject = await outlookService.updateEvent(
      req.params.calendarUserId,
...
router.get('/notifications/reservation/', async function (req, res) {
